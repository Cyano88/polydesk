...
const services: Service[] = [
  ...
  },
  {
    ...
    method: 'POST',
    price: { amount: '0', asset: 'USDT', network: 'X Layer' },
...
export default function a2mcpServicesHandler(_req: Request, res: Response) {
  res.json({
    ...
    rule: 'Every service returns machine-readable JSON. Free marketplace routes deliver directly; paid routes challenge only after provider and preflight checks pass.',
    services,
    docs: '/docs/okx-ai',
  })
}
