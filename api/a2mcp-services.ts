...
const services: Service[] = [
  ...
  },
  {
    ...
    freeSteps: [
      ...
      { endpoint: '/api/polymarket-independent/prepare', purpose: 'Explicitly prepare an independent immediate BUY under buyer-signed limits without requiring ZeroScout approval. GET describes the acknowledgement and inputs; POST checks live execution readiness.' },
    ],
...
export default function a2mcpServicesHandler(_req: Request, res: Response) {
  ...
  res.json({
    ...
    discovery: {
      ...
      publicApi: baseUrl + '/api/v1/capabilities',
      openapi: baseUrl + '/api/v1/openapi.json',
      publicApiStage: 'public-read-foundation',
    ...
    marketplace: {
      ...
      migrationRule: 'Compatibility IDs are historical references, not proof of current listing availability. Query the marketplace for current listings and preserve existing paid obligations during migrations.',
    },
    products: polyDeskMarketplaceProducts,
