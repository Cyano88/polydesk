...
const checks = [
  ...
  { path: '/api/a2mcp/polymarket-funding-link', expect: [400, 402, 503], label: 'funding link preflight or payment gate' },
  { path: '/api/a2mcp/polymarket-funding-link', method: 'POST', body: {}, expect: [400, 402, 503], label: 'funding link POST preflight or payment gate' },
  ...
  { path: '/api/a2mcp/worldcup-live-scores', expect: [404], label: 'retired world cup score service' },
  { path: '/api/a2mcp/worldcup-market-news', expect: [404], label: 'retired world cup news service' },
