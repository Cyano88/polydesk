...
const checks = [
  ...
  { path: '/api/a2mcp/polymarket-funding-link', expect: [402, 503], label: 'marketplace funding payment gate' },
  { path: '/api/a2mcp/polymarket-funding-link', method: 'POST', body: {}, expect: [402, 503], label: 'marketplace funding POST payment gate' },
  { path: '/api/a2mcp/polymarket-portfolio-watch', method: 'POST', body: {}, expect: [402, 503], label: 'marketplace governed trader payment gate' },
  ...
  { path: '/api/a2mcp/worldcup-live-scores', method: 'POST', body: {}, expect: [402, 503], label: 'marketplace football live data payment gate' },
  { path: '/api/a2mcp/worldcup-market-news', method: 'POST', body: {}, expect: [402, 503], label: 'marketplace football news payment gate' },
